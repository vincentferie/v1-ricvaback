import { Body, Controller, Get, Param, Post, Delete, UsePipes, Patch, ParseUUIDPipe, Query, ValidationPipe, Catch, UseGuards } from '@nestjs/common';
...
import { FournisseursDto } from './fournisseurs.dto';
...
export class FournisseursController {
    ...
    constructor(private readonly controllerService: FournisseursService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: FournisseursDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: FournisseursDto,
