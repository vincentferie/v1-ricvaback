...
import { OperationDiverseDto } from './operation-diverse.dto';
...
@ApiTags('operation-diverse')
@Controller('operation-diverse')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Accounting)
export class OperationDiverseController {

    constructor(private readonly controllerService: OperationDiverseService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: OperationDiverseDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: OperationDiverseDto,
