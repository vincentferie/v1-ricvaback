...
import { TransitairesDto } from './transitaires.dto';
...
@ApiTags('transitaires')
@Controller('transitaires')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Financial, Role.Accounting)
export class TransitairesController {

    constructor(private readonly controllerService: TransitairesService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: TransitairesDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: TransitairesDto,
