...
@ApiTags('bilan-num-compte')
@Controller('bilan-num-compte')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Administrator, Role.Accounting)
export class BilanNumCompteController {

    constructor(private readonly bilanService: BilanNumCompteService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() bilanDto: BilanCompteParamsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) bilanDto: BilanCompteParamsDto,
