...
@ApiTags('compte-compta-four')
@Controller('compte-compta-four')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Administrator, Role.Accounting)
export class CompteComptaFourController {

    constructor(private readonly compteComptaService: CompteComptaFourService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() compteDto: CompteComptableFourDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) compteDto: CompteComptableFourDto,
