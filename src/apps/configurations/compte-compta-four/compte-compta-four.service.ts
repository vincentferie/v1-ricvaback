...
import { CompteComptableFourModel } from './compte-compta-four.model';
import { CompteComptableFourDto } from './compte-compta-four.dto';
import { compteLevelFourSeed } from 'src/seeders/fakers';

@Injectable()
export class CompteComptaFourService {
    ...
    constructor(
        ...
        @InjectRepository(CompteComptableFourEntity) private readonly compteRepository: Repository<CompteComptableFourEntity>,
    ) { }

    async save(payload: any, input: CompteComptableFourModel): Promise<CompteComptableFourEntity> {
        let result: any, exception: any;
        try {
            result = await this.compteRepository.save(input as CompteComptableFourDto);
            if (isDefined(result)) {
    ...
    async update(payload: any, input: CompteComptableFourModel, primaryKey: string): Promise<CompteComptableFourEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<CompteComptableFourEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<CompteComptableFourEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<CompteComptableFourEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<CompteComptableFourEntity> {
        let exception: any, result: any;
    ...
    * @function
    */
   create(): Array<Promise<CompteComptableFourEntity>> {
    return compteLevelFourSeed.map(async (item: CompteComptableFourModel) => {
