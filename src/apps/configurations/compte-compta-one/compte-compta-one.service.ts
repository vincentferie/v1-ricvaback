...
import { CompteComptableOneModel } from './compte-compta-one.model';
import { compteLevelOneSeed } from 'src/seeders/fakers';

@Injectable()
export class CompteComptaOneService {
    ...
    constructor(
        ...
        @InjectRepository(CompteComptableOneEntity) private readonly compteRepository: Repository<CompteComptableOneEntity>,
    ) { }

    async save(payload: any, input: CompteComptableOneModel): Promise<CompteComptableOneEntity> {
        let result: any, exception: any;
        try {
            result = await this.compteRepository.save(input as CompteComptableOneDto);
            if (isDefined(result)) {
    ...
    async update(payload: any, input: CompteComptableOneModel, primaryKey: string): Promise<CompteComptableOneEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<CompteComptableOneEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<CompteComptableOneEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<CompteComptableOneEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<CompteComptableOneEntity> {
        let exception: any, result: any;
    ...
    * @function
    */
   create(): Array<Promise<CompteComptableOneEntity>> {
    return compteLevelOneSeed.map(async (item: CompteComptableOneModel) => {
