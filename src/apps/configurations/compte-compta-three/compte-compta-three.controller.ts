...
@ApiTags('compte-compta-three')
@Controller('compte-compta-three')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Administrator, Role.Accounting)
export class CompteComptaThreeController {

    constructor(private readonly compteComptaService: CompteComptaThreeService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() compteDto: CompteComptableThreeDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) compteDto: CompteComptableThreeDto,
