...
import { CompteComptableTwoModel } from './compte-compta-two.model';
import { CompteComptableTwoDto } from './compte-compta-two.dto';
import { compteLevelTwoSeed } from 'src/seeders/fakers';

@Injectable()
export class CompteComptaTwoService {
    ...
    constructor(
        ...
        @InjectRepository(CompteComptableTwoEntity) private readonly compteRepository: Repository<CompteComptableTwoEntity>,
    ) { }

    async save(payload: any, input: CompteComptableTwoModel): Promise<CompteComptableTwoEntity> {
        let result: any, exception: any;
        try {
            result = await this.compteRepository.save(input as CompteComptableTwoDto);
            if (isDefined(result)) {
    ...
    async update(payload: any, input: CompteComptableTwoModel, primaryKey: string): Promise<CompteComptableTwoEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<CompteComptableTwoEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<CompteComptableTwoEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<CompteComptableTwoEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<CompteComptableTwoEntity> {
        let exception: any, result: any;
    ...
    * @function
    */
   create(): Array<Promise<CompteComptableTwoEntity>> {
    return compteLevelTwoSeed.map(async (item: CompteComptableTwoModel) => {
