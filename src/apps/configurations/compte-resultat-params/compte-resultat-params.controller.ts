...
@ApiTags('compte-resultat-params')
@Controller('compte-resultat-params')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Administrator, Role.Accounting)
export class CompteResultatParamsController {

    constructor(private readonly compteComptaService: CompteResultatParamsService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() compteDto: CompteResultatParamsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) compteDto: CompteResultatParamsDto,
