...
import { CompteResultatParamsModel } from './compte-resultat-params.model';
import { CompteResultatParamsDto } from './compte-resultat-params.dto';
import { compteResultatSeed } from 'src/seeders/fakers';

@Injectable()
export class CompteResultatParamsService {
    ...
    constructor(
        ...
        @InjectRepository(CompteResultatParamsEntity) private readonly compteRepository: Repository<CompteResultatParamsEntity>,
    ) { }

    async save(payload: any, input: CompteResultatParamsModel): Promise<CompteResultatParamsEntity> {
        let result: any, exception: any;
        try {
            result = await this.compteRepository.save(input as CompteResultatParamsDto);
            if (isDefined(result)) {
    ...
    async update(payload: any, input: CompteResultatParamsModel, primaryKey: string): Promise<CompteResultatParamsEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<CompteResultatParamsEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<CompteResultatParamsEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<CompteResultatParamsEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<CompteResultatParamsEntity> {
        let exception: any, result: any;
   ...
   * @function
   */
  create(): Array<Promise<CompteResultatParamsEntity>> {
    return compteResultatSeed.map(async (item: CompteResultatParamsModel) => {
