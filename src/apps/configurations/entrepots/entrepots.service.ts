...
import { EntrepotModel } from './entrepot.model';

@Injectable()
export class EntrepotsService {

    constructor(
        @InjectRepository(EntrepotEntity) private readonly entityRepository: Repository<EntrepotEntity>,
    ) { }

    async save(payload: any, input: EntrepotModel): Promise<EntrepotEntity> {
    ...
    async update(payload: any, input: object, primaryKey: string): Promise<EntrepotEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<EntrepotEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<EntrepotEntity[]> {
        let exception: any, result: any;
    ...
    async findPaginate(payload: any, query: any): Promise<EntrepotEntity[]>{
    ...
    async findPaginateResearch(payload: any, query: any): Promise<EntrepotEntity[]>{
        let exception: any, result: any, total: number;
        try {
            [result, total] = await this.entityRepository.findAndCount({
                relations: ['site'],
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<EntrepotEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<EntrepotEntity> {
        let exception: any, result: any;
