...
import { FluxTresorerieParamsModel } from './flux-tresorerie-params.model';
import { FluxTresorerieParamsDto } from './flux-tresorerie-params.dto';
import { fluxTresorerieSeed } from 'src/seeders/fakers';

@Injectable()
export class FluxTresorerieParamsService {
    ...
    constructor(
        ...
        @InjectRepository(FluxTresorerieParamsEntity) private readonly fluxRepository: Repository<FluxTresorerieParamsEntity>,
    ) { }

    async save(payload: any, input: FluxTresorerieParamsModel): Promise<FluxTresorerieParamsEntity> {
        let result: any, exception: any;
        try {
            result = await this.fluxRepository.save(input as FluxTresorerieParamsDto);
            if (isDefined(result)) {
    ...
    async update(payload: any, input: FluxTresorerieParamsModel, primaryKey: string): Promise<FluxTresorerieParamsEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<FluxTresorerieParamsEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<FluxTresorerieParamsEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<FluxTresorerieParamsEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<FluxTresorerieParamsEntity> {
        let exception: any, result: any;
   ...
   * @function
   */
  create(): Array<Promise<FluxTresorerieParamsEntity>> {
    return fluxTresorerieSeed.map(async (item: FluxTresorerieParamsModel) => {
