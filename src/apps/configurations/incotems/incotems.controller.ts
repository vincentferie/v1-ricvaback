...
import { IncotemsDto } from './incotems.dto';
...
export class IncotemsController {

    constructor(private readonly controllerService: IncotemsService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: IncotemsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: IncotemsDto,
