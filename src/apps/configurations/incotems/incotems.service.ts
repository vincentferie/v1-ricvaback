...
import { IncotemsModel } from './incotems.model';
import { incotemSeed } from 'src/seeders/fakers';

@Injectable()
export class IncotemsService {

    constructor(
        @InjectRepository(IncotemsEntity) private readonly entityRepository: Repository<IncotemsEntity>,
    ) { }

    async save(payload: any, input: IncotemsModel): Promise<IncotemsEntity> {
    ...
    async update(payload: any, input: object, primaryKey: string): Promise<IncotemsEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<IncotemsEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<IncotemsEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<IncotemsEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<IncotemsEntity> {
        let exception: any, result: any;
    ...
    * @function
    */
   create(): Array<Promise<IncotemsEntity>> {
    return incotemSeed.map(async (item: IncotemsModel) => {
        return await this.entityRepository
            ...
            .then(async dbresult => {
                ...
                return await this.entityRepository.save(item);
            })
