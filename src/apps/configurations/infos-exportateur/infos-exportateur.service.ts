...
import { InfosExportateurModel } from './infos-exportateur.model';
...
@Injectable()
export class InfosExportateurService {
    constructor(
        @InjectRepository(InfosExportateurEntity) private readonly entityRepository: Repository<InfosExportateurEntity>,
    ) { }

    async save(payload: any, input: InfosExportateurModel): Promise<InfosExportateurEntity> {
        let result: any, exception: any;

        try {
            input.raison = input.raison.toUpperCase();
    ...
    async update(payload: any, input: any, primaryKey: string): Promise<InfosExportateurEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<InfosExportateurEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<InfosExportateurEntity[]> {
        let exception: any, result: any;
    ...
    async findPaginate(payload: any, query: any): Promise<InfosExportateurEntity[]>{
    ...
    async findPaginateResearch(payload: any, query: any): Promise<InfosExportateurEntity[]>{
        let exception: any, result: any, total: number;
        try {
            [result, total] = await this.entityRepository.findAndCount({
                where: [
                    {
                        raison: ILike(`%${query.query}%`),
                        mode: SoftDelete.active
                    },
                    {
                        contribuable: ILike(`%${query.query}%`),
                        mode: SoftDelete.active
                    },
                    {
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<InfosExportateurEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<InfosExportateurEntity> {
        let exception: any, result: any;
