...
import { RubriquesChargesModel } from './rubrique-charges.model';

@Injectable()
export class RubriqueChargesService {
    constructor(
        ...
        @InjectRepository(RubriquesChargesEntity) private readonly entityRepository: Repository<RubriquesChargesEntity>,
    ) { }

    async save(payload: any, input: RubriquesChargesModel): Promise<RubriquesChargesEntity> {
    ...
    async update(payload: any, input: RubriquesChargesModel, primaryKey: string): Promise<RubriquesChargesEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<RubriquesChargesEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<RubriquesChargesEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<RubriquesChargesEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<RubriquesChargesEntity> {
        let exception: any, result: any;
