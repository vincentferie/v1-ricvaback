...
import { TypeChargesModel } from './type-charges.model';

@Injectable()
export class TypeChargesService {
    constructor(
        ...
        @InjectRepository(TypeChargesEntity) private readonly entityRepository: Repository<TypeChargesEntity>,
    ) { }

    async save(payload: any, input: TypeChargesModel): Promise<TypeChargesEntity> {
    ...
    async update(payload: any, input: TypeChargesModel, primaryKey: string): Promise<TypeChargesEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<TypeChargesEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<TypeChargesEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<TypeChargesEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<TypeChargesEntity> {
        let exception: any, result: any;
