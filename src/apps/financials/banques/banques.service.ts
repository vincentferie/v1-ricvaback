...
import { BanquesModel } from './banques.model';
@Injectable()
export class BanquesService {

    constructor(
        @InjectRepository(BanquesEntity) private readonly entityRepository: Repository<BanquesEntity>,
    ) { }

    async save(payload:any, input: BanquesModel): Promise<BanquesEntity> {
    ...
    async update(payload:any, input: object, primaryKey: string): Promise<BanquesEntity> {
    ...
    async updateMode(payload:any, primaryKey: string, mode: SoftDelete): Promise<BanquesEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload:any, query: object): Promise<BanquesEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload:any, mode: SoftDelete): Promise<BanquesEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload:any, primaryKey: string): Promise<BanquesEntity> {
        let exception: any, result: any;
