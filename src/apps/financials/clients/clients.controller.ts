...
export class ClientsController {
    ...
    constructor(private readonly controllerService: ClientsService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: ClientsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: ClientsDto,
