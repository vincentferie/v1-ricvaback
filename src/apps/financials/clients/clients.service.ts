...
export class ClientsService {
    ...
    constructor(
        @InjectRepository(ClientsEntity) private readonly entityRepository: Repository<ClientsEntity>,
    ) { }

    async save(payload:any, input: ClientsModel): Promise<ClientsEntity> {
    ...
    async update(payload:any, input: object, primaryKey: string): Promise<ClientsEntity> {
    ...
    async updateMode(payload:any, primaryKey: string, mode: SoftDelete): Promise<ClientsEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload:any, query: object): Promise<ClientsEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload:any, mode: SoftDelete): Promise<ClientsEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload:any, primaryKey: string): Promise<ClientsEntity> {
        let exception: any, result: any;
