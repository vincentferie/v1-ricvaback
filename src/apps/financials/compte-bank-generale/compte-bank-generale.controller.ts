...
import { CompteBankGeneraleDto } from './compte-bank-generale.dto';
...
@ApiTags('compte-bank-generale')
@Controller('compte-bank-generale')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Financial)
export class CompteBankGeneraleController {

    constructor(private readonly controllerService: CompteBankGeneraleService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: CompteBankGeneraleDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: CompteBankGeneraleDto,
