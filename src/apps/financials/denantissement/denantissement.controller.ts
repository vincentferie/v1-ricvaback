...
import { DenantissementDto } from './denantissement.dto';
...
@ApiTags('denantissement')
@Controller('denantissement')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Financial)
export class DenantissementController {

    constructor(private readonly controllerService: DenantissementService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: DenantissementDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: DenantissementDto,
