...
@ApiTags('reglement-factures-bl')
@Controller('reglement-factures-bl')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Financial)
export class ReglementFacturesBlController {
    constructor(private readonly controllerService: ReglementFacturesBlService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: ReglementsFactureBlDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: ReglementsFactureBlDto,
