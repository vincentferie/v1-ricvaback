...
import { TierDetenteursModel } from './tiers-detenteur.model';

@Injectable()
export class TiersDetenteurService {

    constructor(
        @InjectRepository(TierDetenteursEntity) private readonly entityRepository: Repository<TierDetenteursEntity>,
    ) { }

    async save(payload: any, input: TierDetenteursModel): Promise<TierDetenteursEntity> {
    ...
    async update(payload: any, input: object, primaryKey: string): Promise<TierDetenteursEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<TierDetenteursEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<TierDetenteursEntity[]> {
        let exception: any, result: any;
    ...
    async findByBank(payload: any, primaryKey: string): Promise<TierDetenteursEntity[]>{
        let exception: any, result: any;
        try {
            result = await this.entityRepository.find({
                relations: ['banque'],
                where: [{banque_id: primaryKey, mode: SoftDelete.active}]
            });
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<TierDetenteursEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<TierDetenteursEntity> {
        let exception: any, result: any;
