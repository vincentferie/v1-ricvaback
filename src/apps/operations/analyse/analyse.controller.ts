...
import { AnalysesDto } from './analyse.dto';
...
export class AnalysesController {
    ...
    constructor(private readonly controllerService: AnalysesService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: AnalysesDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: AnalysesDto,
