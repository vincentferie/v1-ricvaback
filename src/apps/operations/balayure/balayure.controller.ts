...
import { BalayureDto } from './balayure.dto';
...
export class BalayureController {

    constructor(private readonly controllerService: BalayureService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: BalayureDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: BalayureDto,
