...
import { PlombsDto } from './plomb.dto';
import { PlombsService } from './plomb.service';

@ApiTags('plomb-conteneurs')
@Controller('plomb-conteneurs')
@UseGuards(AuthGuard('jwt'))
@Roles(Role.Manager, Role.Operator)
export class PlombsController {

    constructor(private readonly controllerService: PlombsService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: PlombsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: PlombsDto,
