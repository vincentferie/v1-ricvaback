...
import { PlombModel } from './plomb.model';

@Injectable()
export class PlombsService {

    constructor(
        @InjectRepository(PlombEntity) private readonly entityRepository: Repository<PlombEntity>,
    ) { }

    async save(payload: any, input: PlombModel): Promise<PlombEntity> {
    ...
    async update(payload: any, input: object, primaryKey: string): Promise<PlombEntity> {
    ...
    async updateMode(payload: any, primaryKey: string, mode: SoftDelete): Promise<PlombEntity> {
        let exception: any, result: any;
        const response = await this.checkById(primaryKey);
    ...
    async find(payload: any, query: object): Promise<PlombEntity[]> {
        let exception: any, result: any;
    ...
    async findMode(payload: any, mode: SoftDelete): Promise<PlombEntity[]> {
        let exception: any, result: any;
    ...
    async findById(payload: any, primaryKey: string): Promise<PlombEntity> {
        let exception: any, result: any;
