...
export class SessionController {
    ...
    constructor(private readonly controllerService: SessionService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: SessionDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: SessionDto,
