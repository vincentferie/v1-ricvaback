...
import { TransfertsDto } from './transfert.dto';
...
export class TransfertsController {
    ...
    constructor(private readonly controllerService: TransfertsService) { }

    @Post()
    @UsePipes(ValidationPipe)
    async save(@JwtInfoGetter() payload, @Body() inputDto: TransfertsDto) {
    ...
    async update(
        ...
        @Body(ValidationPipe) inputDto: TransfertsDto,
